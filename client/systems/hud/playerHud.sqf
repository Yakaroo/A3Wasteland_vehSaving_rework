...
while {true} do
{
	...
	_serverString = format ["<t color='#A0FFFFFF'>Server: TRSA Wasteland Altis</t>", call A3W_extDB_ServerID];
	_serverString = format ["%1<br/><t color='#A0FFFFFF'>Teamspeak: 188.138.110.166</t>",_serverString];
	...
	{
		_tempString = format ["<t color='#A0FFFFFF'>TRSA A3Wasteland</t>", getText (configFile >> "CfgWorlds" >> worldName >> "description")];
		_yOffset = 0.28;
